        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li class="active"><a href="contacttable.php"><i class="fa fa-circle-o"></i>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Kontaktübersicht</li>
            </ol>
        </section>
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="box">
                        ...
                        <div class="box-body">
                            <?PHP
                            echo "<form role=\"form\" action=\"contactchange.php\" 
                              method=\"post\">";
                            ?>
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                $abfrage = "select company, surname, lastname, mail, id from contact";
