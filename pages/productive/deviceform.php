            ...
            <ul class="sidebar-menu" data-widget="tree">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li class="active"><a href="deviceform.php"><i class="fa fa-circle-o"></i> Gerät erfassen</a></li>
                        ...
                        <form role="form">
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control" id="Gerätetyp" placeholder="Gerätetyp">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="Inventarnummer" placeholder="Inventarnummer">
                                </div>
                                <div class="form-group">
                                    <label>Kaufdatum</label>
                                    <input type="text" class="form-control" id="Kaufdatum" placeholder="Kaufdatum">
                                </div>
                            </div>
                            <!-- /.box-body -->
